...
const HeroSection = () => {
    return (
        <div className='container mx-auto flex justify-between items-center my-22'>
            <div className='left-side space-y-4'>
                ...
                <div className='space-y-4'>
                    <h2 className='font-extrabold text-7xl text-[#101727FF] leading-[1.2]'>Supercharge Your <br />Digital Workflow</h2>
                    <p className='leading-7 text-[18px] text-[#627382FF]'>Access premium AI tools, design assets, templates, and productivity <br /> software—all in one place. Start creating faster today. <br />Explore Products</p>
                </div>
